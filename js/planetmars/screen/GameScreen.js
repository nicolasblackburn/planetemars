var planetmars = (function(pm, undefined) {
    function GameScreen(game) {
        ...
        this.element = $('<div class="screen hidden" id="game-screen">')
    ...
    GameScreen.prototype.initTileCollisionShapes = function() {
        this.tileCollisionShapes = {
            ...
            35: pm.geom.rightTriangle(
                [this.tileWidth, this.tileHeight], [-this.tileWidth, -this.tileHeight]), // Triangle rectangle coin inférieur droit

            36: pm.geom.rightTriangle(
                [0, this.tileHeight], [this.tileWidth, -this.tileHeight]), // Triangle rectangle coin inférieur gauche

            68: pm.geom.rightTriangle(
                [0, 0], [this.tileWidth, this.tileHeight]), // Triangle rectangle coin supérieur gauche

            67: pm.geom.rightTriangle(
                [this.tileWidth, 0], [-this.tileWidth, this.tileHeight]) // Triangle rectangle coin supérieur droit
        };
    };
            ...
            for (i = tilexstart; i < tilexstop; i++) {
                ...
                if (this.tileCollisionShapes[tile.tileId]) {
                    shape2 = pm.geom.translate(
                        this.tileCollisionShapes[tile.tileId], [tilex, tiley]);
    ...
    GameScreen.prototype.setupRoom = function() {
		...
		event = new pm.event.RoomEnterEvent(this);
		this.dispatchEvent(event);
    };

    GameScreen.prototype.update = function() {
        var self = this,
            spawn, i, objects, oldPosition, oldVelocity;
